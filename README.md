...
Django-зошит із 11 навчальними розділами та бонусом українською. Викладач створює групи та учнів, видає згенеровані логіни й паролі, відкриває розділи та переглядає відповіді. Учням не потрібна реєстрація.
