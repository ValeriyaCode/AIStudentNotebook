...
class GroupTests(TestCase):
    ...
    def test_locked_pages_and_pdf_and_opening(self):
        ...
        self.assertContains(self.client.get(reverse('dashboard')), 'aria-disabled="true"', count=12)
    ...
    def test_transfer(self):
        ...
        self.assertContains(self.client.get(reverse('group_detail', args=[target.pk])), student.get_full_name())
